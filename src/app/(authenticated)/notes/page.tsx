...
export interface Note {
  ...
  color?: string; // e.g., 'yellow', 'blue', 'default'
}

// Dummy notes
const initialNotes: Note[] = [
  { id: "n1", title: "Project Ideas", content: "Brainstorm new features for the ProHub dashboard. Consider AI-driven insights or a team collaboration module.", createdAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(), color: "yellow" },
  { id: "n2", title: "Weekly Goals", content: "1. Finalize Q4 budget.\n2. Conduct user interviews for feedback.\n3. Write blog post on productivity.", createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(), color: "green" },
  { id: "n3", title: "Book Recommendations", content: "Atomic Habits by James Clear\nDeep Work by Cal Newport\nThe Pragmatic Programmer", createdAt: new Date().toISOString(), color: "blue" },
  { id: "n4", title: "Quick Reminder", content: "Pick up dry cleaning on Friday after 5 PM.", createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), color: "default" },
];
    ...
    <div className="space-y-6">
      ...
      {notes.length === 0 ? (
        <div className="text-center py-10">
          <StickyNote className="mx-auto h-16 w-16 text-muted-foreground opacity-50" />
          <p className="mt-4 text-lg font-medium text-muted-foreground">No notes yet.</p>
